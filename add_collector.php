        ...
        <div class="content-wrapper">
          <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Add Collector</li>
                </ol>
            </nav>
          </div>
          <div class="row">
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Add Collector</h4>
                  ...
                  <form class="forms-sample" method="POST" action="" id="">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputname1" Name="name1" placeholder="Name">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputUsername1">Mobile Number</label>
                      <input type="text" class="form-control" id="exampleInputmobilenumber" Name="mobilenumber" placeholder="Mobile Number">
                    </div>
                    <div class="form-group">
